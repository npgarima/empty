...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (empty(trim($_POST["title"])) || empty(trim($_POST["keywords"])) || empty(trim($_POST["np-content"]))  || empty(trim($_POST["en-author"])) || empty(trim($_POST["np-author"])) ||   empty(trim($_POST["en-content"]))) {
        ...
        $sql = "INSERT INTO posts (title,keywords,en_content,en_author,np_content,np_author,media,en_podcast_url,np_podcast_url,published) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor-en" name="en-content"></textarea>
                            </div>

                            <div class="form-group">
                                <label>Content(Nepali)</label>
                                <textarea id="editor-np" name="np-content"></textarea>
                            </div>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <input  name="status" type="checkbox" checked id="flexCheckDefault">
                ...
                <div class="form-group">
                    ...
                    <input type="text" data-role="tagsinput" name="keywords" class="form-control" placeholder="Keywords for the contents">
                </div>

                <div class="form-group">
                    <label>Author(English)</label>
                    <input type="text" name="en-author" class="form-control" placeholder="English Content Author...">
                </div>

                <div class="form-group">
                    <label>Author(Nepali)</label>
                    <input type="text" name="np-author" class="form-control" placeholder="Nepali Content Author...">
                </div>
